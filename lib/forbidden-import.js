...
var checkImportSpecifier = require('./ast/import-specifier');
...
module.exports = function(context) {
    ...
    if (forbiddenModuleMasks.length > 0) {
        return {
            ...
            ImportSpecifier: checkImportSpecifier(context, forbiddenModuleMasks),
...
function getForbiddenModuleMasks(context) {
    ...
    return moduleMasks.map(function (mask) {
